...
/*------------MÉTODOS----------------*/
    @Override
    public String comer() {
        return "- Un "+getClass().getSimpleName()+" de color('"+color+"') de la especie ('"+especie_lobo+"') con un peso de "+peso+"kg son carnívoros con colmillos de "
                +tamaño_colmillos+" cm, su alimentación se basa principalmente en animales de tamaño medio como cerdos, cabras, ciervos.";
    }

    @Override
    public String dormir() {
        return "\n- El "+getClass().getSimpleName()+" de la especie ('"+especie_lobo+"') del habitad ('"+habitat+"') son conocidos por mantenerse despiertos hasta " +
                "altas horas de la noche y dormir más durante el día.";
    }

    @Override
    public String correr() {
        return "\n- El "+getClass().getSimpleName()+" nombre científico ('"+nombre_científico+"') y una altura de "+altura+"mts, están adaptados para carreras de larga distancia. " +
