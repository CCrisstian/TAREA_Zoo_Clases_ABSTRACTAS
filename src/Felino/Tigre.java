...
/*------------MÉTODOS----------------*/
    ...
    public String dormir() {
        return "\n- Los "+getClass().getSimpleName()+" de la especie: "+especie_de_Tigre+" son animales nocturnos y pasan gran parte del día durmiendo o " +
    ...
    public String comunicarse() {
        return "\n- Aunque son animales solitarios, los "+getClass().getSimpleName()+" de la especie: "+especie_de_Tigre+" establecen un sistema de relaciones " +
    ...
    public String Generar_Ficha() {
        ...
        ficha.append("\n\tEspecia de Felino.Tigre: ").append(especie_de_Tigre);
        ficha.append("\n---------------------------------------------------------------------------------------------------------------");
